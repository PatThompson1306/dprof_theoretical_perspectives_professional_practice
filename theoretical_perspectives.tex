...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.25\textheight, keepaspectratio=false]{images/research_stack.png}
...
% \input{search_matrix} --- a table showing which databases were searched for each track, with the search strings used in each case; this sits outside the word count. 
...
% \input{inclusion_criteria} -- a table showing the inclusion criteria for each track, with a justification for each criterion; this sits outside the word count.

\vspace{8pt}

% \input{exclusion_criteria} -- a table showing the exclusion criteria for each track, with a justification for each criterion; this sits outside the word count.
