...
This chapter explores the landscape of \gls{csa} and the demand it places on policing, before exploring the gap between demand and proactive capability.  This gap is the problem space which this research seeks to address, and therefore it is important to understand the nature of the problem and the demand on policing before exploring potential solutions.  This chapter also explores the grooming to contact offending pathway, which is the specific focus of this research.  Understanding this pathway is critical to the development of an \gls{nlp} solution which seeks to identify precursors of contact offending, as it provides the empirical foundation for identifying the linguistic characteristics which may be present in offender-victim conversations prior to contact offending.
\section{The scale of CSA reporting and the demand on policing}
\label{sec:the-scale-of-csa-reporting-and-the-demand-on-policing}
The measurement of crime statistics in the \gls{uk} is complex, with two primary sources of data providing different perspectives on crime, \citep{ariel2019crime}.  The \gls{csew} acts as a household survey of crime focussing on participants' self reported experiences of crime.  Simultaneously, police recorded crime data captures crimes reported to the police.  It is therefore a truism that neither dataset can be considered a definitive measure of crime.  
This is evidenced clearly in the gulf of \gls{csa} reporting noted between the \gls{vkpp} who note 122,768 recorded \gls{csa} offences in 2024, \citep{vkpp2025national}, compared to an estimated 500,000 \gls{csa} offences annually noted by Baroness Casey, \citep{casey2025gbcse}.
