...
The synthesed findings from this cross domain review will be used to develop a conceptual framework which identifies the organisational requirements for operationalising an \gls{nlp} solution in a policing context, and the technical capabilities required to meet those requirements.

\section{Tools and software}
\label{sec:tools-and-software}
The multifaceted nature of this review demands a robust literature and note management strategy supported by appropriate tools.  \citet{basu2020what} describes the \gls{zettelkasten} method which can be used to manage literature sources and create links between them, supporting the synthesis process.  This is furthered by \citet{reck2023tips} who describes the \gls{zk} method as a process of creating notes on individual literature sources, applying tags to those notes and then using the tagging system to create links between the notes.  Both \citet{basu2020what} and \citet{reck2023tips} describe the \gls{zk} method as the process of building a \gls{pkms}.  \cite{cheong2011skills} describes a \gls{pkms} as a structure which allows for the development of \say{personal information management, personal knowledge internalization, personal wisdom creation, and interpersonal knowledge transferring}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/research_stack.png}
    \caption{\gls{zk} method application for literature and note management}
    \label{fig:research-stack}
\end{figure}


% 100 words -- software stack and process used in managing literature (include a diagram!), with justification for choices and how they support the review methodology
