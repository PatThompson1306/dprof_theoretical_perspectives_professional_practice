...
A PRISMA diagram is presented in figure \ref{fig:TBC PRISMA CHART} which summarises the results of the search strategy, including the number of records identified, screened, and included in the review.  The following notes are relevant to the interpretation of this diagram:

An initial return of 3,150 papers was obtained.  After the removal of duplicate papers, and the removal of immediately identifiably irrelevant papers (for example, papers presenting with no abstract or with no full text availability), a total 2,029 papers remained.  An initial visual scan of the titles of these papers revealed a high degree of topic adjacency.  It was apparant that the contemporary explosion of interest in \gls{ai} and \gls{nlp} had returned a large number of papers which were likley not connected to this research.  Accordingly an title based key word screening process was implemented which sought to remove papers which were not relevant to this research.  These keywords are noted in figure \ref{fig:TBC PRISMA CHART} and were designed to remove papers which were likely to be irrelevant to this research, for example papers focused on non\gls{nlp} \gls{ai} applications or the delivery of \gls{nlp} applications in the healthcare or finance sectors.  This process reduced the number of papers to 1,471.  

Following this initial title screening, a secondary title review was completed.  This reduced the papers in scope to 451.

Finally, an abstract based screening process was then implemented, which sought to identify papers which were not relevant to this research based on their abstract content and the inclusion and exclusion criteria noted in tables \ref{tab:inclusion-criteria} and \ref{tab:exclusion-criteria}.  

This process reduced the number of papers to XXX.  Finally, a full text review was conducted on these remaining papers, with a final selection of XXX papers included in the review.
