...
\input{inclusion_criteria} % a table showing the inclusion criteria for each track, with a justification for each criterion

\vspace{8pt}

\input{exclusion_criteria} % a table showing the exclusion criteria for each track, with a justification for each criterion
