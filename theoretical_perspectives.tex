...
% 175 words -- introduce the dual-track nature of the inquiry and signpost the structure
...
The research area is inherently interdisciplinary, positioned at the intersection of technical and organisational domains. Accordingly, the literature review is structured into three parallel tracks:

\begin{enumerate}
    \item The first track explores the landscape of \gls{csa} and the challenges it poses for policing.
    \item The second track reviews the technical literature on \gls{nlp} applications in safeguarding and criminal justice contexts, focusing on grooming language detection.
    \item The third track examines the organisational dynamics of technology adoption in policing, drawing on change management theories and empirical observations.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Which NLP methods can be most effectively realised within policing infrastructure?
...
% 175 words -- briefly situate the paper within your professional role and the broader CSE landscape to ground the reader
